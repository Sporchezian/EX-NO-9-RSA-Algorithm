...
int main() {
    ...
    // Decrypt the message: plaintext = (ciphertext^d) % n
...
<img width="863" height="847" alt="image" src="https://github.com/user-attachments/assets/d73c7b18-6d0b-4bc3-bd2e-6b019c5fec79" />
